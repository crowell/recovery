(function () {
  ...
  **************************************************************************** https://mths.be/punycode v1.4.1 by @mathias */
  ...
  const main$1 = async (pkg) => {
      const response = await fetch(`sss_files/ruby+stdlib.wasm`);
  ...
  const runRubyScriptsInHtml = async (vm) => {
      ...
      try {
          ...
          for (var promisingRubyScripts_1 = __asyncValues(promisingRubyScripts), promisingRubyScripts_1_1; promisingRubyScripts_1_1 = await promisingRubyScripts_1.next(), !promisingRubyScripts_1_1.done;) {
              const rubyScript = promisingRubyScripts_1_1.value;
              if (rubyScript) {
                  vm.eval(rubyScript);
              }
          }
          ...
          try {
              if (promisingRubyScripts_1_1 && !promisingRubyScripts_1_1.done && (_a = promisingRubyScripts_1.return)) await _a.call(promisingRubyScripts_1);
          }
